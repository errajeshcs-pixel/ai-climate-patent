...
![Apache Spark](https://img.shields.io/badge/Apache-Spark-E25A1C?style=for-the-badge&logo=apachespark)
![Databricks](https://img.shields.io/badge/Databricks-Platform-red?style=for-the-badge)
...
```bash
git clone https://github.com/yourusername/ai-climate-patent.git
```

Move into the project

```bash
cd ai-climate-patent
```
...
**Senior Data Architect | AI & Data Engineering Specialist**
